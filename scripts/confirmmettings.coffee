...
module.exports = (robot) ->
    robot.respond /confirm meetings/i, (msg) ->
        ...
        if sender is "margaret.anne.storey" || sender is "cassie"
            msg.send room: 'general', "<!channel>: Please check the calendar and let <@margaret.anne.storey> know if the time doesn't work for you. You can switch directly if someone will switch with you, or remove it if you don't need to meet."
        else
